...
The app checks once a day, on unmetered wifi only. It verifies the SHA-256 and
the signing certificate before offering the update, and Android asks you to
confirm every install. Nothing here installs silently.
